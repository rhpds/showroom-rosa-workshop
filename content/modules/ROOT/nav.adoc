...
* xref:100-environment/lab_2_cluster_creation.adoc[Create a ROSA cluster]
// * xref: 100-environment/lab_3_cluster_creation_hcp.adoc[Create a ROSA cluster with Hosted Control Planes]
* xref:100-environment/lab_4_access_cluster.adoc[Access your ROSA cluster]
