...
[WARNING]
====
This workshop was built with Red Hat OpenShift Service Mesh 2. It is not yet compatible with Service Mesh 3. Please ensure you are using version 2 for this workshop.
====
...
* The **Kiali Operator (Provided by Red Hat)** and **Red Hat OpenShift Service Mesh 2** operators are installed in the `openshift-operators` namespace and are available for all namespaces in the cluster.
