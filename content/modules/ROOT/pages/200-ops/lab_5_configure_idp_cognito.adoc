...
. Click on *Cognito* and use the userid `admin` with password `{ssh_password}-2@23`. You will be prompted to change your password. Just enter the existing password two more times.
