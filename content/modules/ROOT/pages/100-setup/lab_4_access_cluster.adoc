...
====
* Admin User: {rosa_admin_user}
* Admin Password: {rosa_admin_password}
* OpenShift API URL: {rosa_api_url}
* OpenShift Web Console: {rosa_console_url}
====
...
----
export ADMIN_PASSWORD={rosa_admin_password}
----
+
Save the admin password in your `.bashrc`
+
...
[source,sh,subs=attributes,role=execute]
----
oc login {rosa_api_url} --username {rosa_admin_user} --password {rosa_admin_password}
----
+
.Sample Output
[source,texinfo,options=nowrap]
