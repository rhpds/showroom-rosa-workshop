...
[source,text,options=nowrap]
----
Warning: would violate PodSecurity "restricted:v1.24": runAsNonRoot != true (pod or container "bgd" must set securityContext.runAsNonRoot=true), seccompProfile (pod or container "bgd" must set securityContext.seccompProfile.type to "RuntimeDefault" or "Localhost")
