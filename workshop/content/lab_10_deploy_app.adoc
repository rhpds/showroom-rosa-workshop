...
While in the route section of the OpenShift Web Console, click the URL under _Location_: image::media/rosa-console-route-link.png[OpenShift Web Console - Route Link]
...
Back in your Cloud Shell environment, run the following command:
