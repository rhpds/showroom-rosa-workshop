...
== Enable Autoscaling on the Default MachinePool using the Rosa CLI
...
rosa-6n4s8-7hbhw-worker-us-west-2a   MachineSet   rosa-6n4s8-7hbhw-worker-us-west-2a   2     4     4m30s
----
...
[source,text,options=nowrap]
----
Warning: would violate PodSecurity "restricted:v1.24": runAsNonRoot != true (pod or container "work" must set securityContext.runAsNonRoot=true), seccompProfile (pod or container "work" must set securityContext.seccompProfile.type to "RuntimeDefault" or "Localhost")
...
rosa-6n4s8-7hbhw-infra-us-west-2a    2         2         2       2           23h
rosa-6n4s8-7hbhw-worker-us-west-2a   4         4         2       2           23h
----
+
...
rosa-6n4s8-7hbhw-worker-us-west-2a-vpfqr   Provisioned   m5.xlarge   us-west-2   us-west-2a   99s
rosa-6n4s8-7hbhw-worker-us-west-2a-wwmj7   Provisioned   m5.xlarge   us-west-2   us-west-2a   99s
