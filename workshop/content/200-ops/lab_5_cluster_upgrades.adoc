...
Recommended updates:
  ...
  VERSION     IMAGE
  4.12.13     quay.io/openshift-release-dev/ocp-release@sha256:db976910d909373b1136261a5479ed18ec08c93971285ff760ce75c6217d3943
----
+
[NOTE]
====
...
? Are you sure you want to upgrade cluster to version '4.12.10'? Yes
