...
In this lab environment you do not have access to the OpenShift Cluster Manager so we have to use the CLI.
...
Recommended updates:
  ...
  4.13.1      quay.io/openshift-release-dev/ocp-release@sha256:9c92b5ec203ee7f81626cc4e9f02086484056a76548961e5895916f136302b1f
----
+
[NOTE]
====
